...
class BackpackWidget(QOpenGLWidget):
    ...
    def initializeGL(self):
        ...
        if not self.shader_program.addShaderFromSourceFile(QOpenGLShader.Vertex, 'vertex_shader.glsl'):
            print("Vertex Shader Error:", self.shader_program.log())
        if not self.shader_program.addShaderFromSourceFile(QOpenGLShader.Fragment, 'fragment_shader.glsl'):
